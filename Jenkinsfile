pipeline {
  ...
  environment {
    ...
    EXT_USER = 'plankanban'
    EXT_REPO = 'planka'
    BUILD_VERSION_ARG = 'PLANKA_RELEASE'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-planka'
    CONTAINER_NAME = 'planka'
    DOCKERHUB_IMAGE = 'linuxserver/planka'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/planka'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-planka/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-planka\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-planka\" \
          ...
          --label \"org.opencontainers.image.description=[Planka](https://github.com/plankanban/planka/) is an elegant open source project tracking tool.\" \
